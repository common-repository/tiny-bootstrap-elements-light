...
/*global $, jQuery, window, prettyPrint, parent, context*/
'use strict';
function makeResponsive()
{
    if ($('body', context).width() < 768) {
        $('.container', context).addClass('container-xs');
    }
}
...
$('#code-slide-link', context).on('click', function () {
...
$.fn.scrollToTop = function(){ if (this.length > 0) $('body, html', context).animate({scrollTop: $(this).offset().top}, 500); };